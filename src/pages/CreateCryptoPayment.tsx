...
const CreateCryptoPayment = () => {
  ...
  const [description, setDescription] = useState<string>(
    "Wallet funding with cryptocurrency"
  );
  ...
  const handleCreateCryptoPayment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await apiRequest(
        PAYMENT_ENDPOINTS.CREATE_CRYPTO,
        "POST",
        paymentData
      );
                  ...
                  <div className="flex">
                    <div className="text-sm text-blue-700">
                      ...
                      <ul className="mt-1 list-disc list-inside">
                        ...
                        <li>
                          Instant conversion to USD at current market rates
                        </li>
                        <li>
                          Funds will be available in your wallet after
                          confirmation
                        </li>
                      </ul>
                    </div>
